...
public class MongoDBRealmConstants {
	 ...
	 public static final String SELECT_USER = "SelectUserMONGO_QUERY";
		...
		public static final String GET_ROLE_LIST_MONGO_QUERY = "{'collection' : 'UM_ROLE','UM_TENANT_ID' : '?','UM_ROLE_NAME' : '?','UM_SHARED_ROLE' : '0','projection': {'UM_ROLE_NAME' : '1','UM_TENANT_ID' : 1,'UM_SHARED_ROLE' : 1,'_id' : '0'}}";
	    public static final String GET_USER_FILTER_MONGO_QUERY = "{'collection' : 'UM_USER','$match' : {'UM_USER_NAME' : '?','UM_TENANT_ID' : '?'},'$project' : {'name' : '$_id','UM_USER_NAME' : '1','_id' : '0'},'$sort' : {'UM_USER_NAME' : 1}}";
	    public static final String GET_USER_ROLE_MONGO_QUERY = "{'collection' : 'UM_ROLE',$match : {'UM_TENANT_ID' : '?','userRole.UM_TENANT_ID' : '?','users.UM_TENANT_ID' : '?','users.UM_ID' : '?'},'$project' : {'UM_ROLE_NAME' : 1,'_id' : 0},'$lookup' : {'from' : 'UM_USER_ROLE','localField' : 'UM_ID','foreignField' : 'UM_ROLE_ID','as' : 'userRole'},'$unwind' : {'path' : '$userRole','preserveNullAndEmptyArrays' : false},'$lookup_sub' : {'from' : 'UM_USER','localField' : 'userRole.UM_USER_ID','foreignField' : 'UM_ID','as' : 'users','dependency' : 'userRole'},'$unwind_sub' : {'path' : '$users','preserveNullAndEmptyArrays' : false}}";
	                                                   
	    public static final String GET_IS_ROLE_EXISTING_MONGO_QUERY = "{'collection' : 'UM_ROLE','UM_ROLE_NAME' : '?','UM_TENANT_ID' : '?','projection' : {'UM_ID' : 1,'_id' : 0}}";
	    public static final String GET_USERS_IN_ROLE_MONGO_QUERY = "{'collection' : 'UM_USER',$match : {'UM_TENANT_ID' : '?','role.UM_ROLE_NAME' : '?','role.UM_TENANT_ID' : '?','userRole.UM_TENANT_ID' : '?'},'$project' : {'UM_USER_NAME' : 1,'_id' : 0},'$lookup' : {'from' : 'UM_USER_ROLE','localField' : 'UM_ID','foreignField' : 'UM_USER_ID','as' : 'userRole'},'$lookup_sub' : {'from' : 'UM_ROLE','localField' : 'userRole.UM_ROLE_ID','foreignField' : 'UM_ID','as' : 'role','dependency' : 'userRole'},'$unwind' : {'path' : '$userRole','preserveNullAndEmptyArrays' : false},'$unwind_sub' : {'path' : '$role','preserveNullAndEmptyArrays' : false}}";
	    public static final String GET_IS_USER_EXISTING_MONGO_QUERY = "{'collection' : 'UM_USER','UM_USER_NAME' : '?','UM_TENANT_ID' : '?','projection' : {'UM_ID' : '1','_id' : '0'}}";
	    public static final String GET_PROPS_FOR_PROFILE_MONGO_QUERY = "{'collection' : 'UM_USER_ATTRIBUTE','$match' : {'UM_PROFILE_ID' : '?','UM_TENANT_ID' : '?','users.UM_USER_NAME' : '?','users.UM_TENANT_ID' : '?'},'$lookup' : {'from' : 'UM_USER','localField' : 'UM_USER_ID','foreignField' : 'UM_ID','as' : 'users'},'$unwind' : {'path' : '$users','preserveNullAndEmptyArrays' : false}}";
	    public static final String GET_PROP_FOR_PROFILE_MONGO_QUERY = "{'collection' : 'UM_USER_ATTRIBUTE','UM_USER_ID' : '?','UM_TENANT_ID' : '?'}";
	    ...
	    public static final String USER_NAME_UNIQUE_MONGO_QUERY = "{'collection' : 'UM_USER','UM_USER_NAME' : '?','projection' : {'UM_ID' : '1','_id' : '0'}}";
        ...
        public static final String ADD_DOMAIN_MONGO_QUERY = "{'collection' : 'UM_DOMAIN','UM_DOMAIN_NAME' : '?','UM_TENANT_ID' : '?','UM_DOMAIN_ID' : '?'}";
		...
		public static final String DELETE_DOMAIN_MONGO_QUERY = "{'collection' : 'UM_DOMAIN','UM_DOMAIN_NAME' : '?','UM_TENANT_ID' : '?'}";
        public static final String UPDATE_DOMAIN_MONGO_QUERY = "{'collection' : 'UM_DOMAIN','UM_DOMAIN_NAME' : '?','UM_TENANT_ID' : '?','projection' : {'$set' : {'UM_DOMAIN_NAME' : '?'}}}";
        public static final String IS_DOMAIN_EXISTING_MONGO_QUERY = "{'collection' : 'UM_DOMAIN','UM_DOMAIN_NAME' : '?','UM_TENANT_ID' : '?','projection' : {'UM_DOMAIN_ID' : '1'}}";
        public static final String CHECK_DOMAIN_ID_EXISTING_MONGO_QUERY = "{'collection' : 'UM_DOMAIN','UM_DOMAIN_ID' : '?','UM_TENANT_ID' : '?','projection' : {'$set' : {'UM_DOMAIN_ID' : '1'}}}";
