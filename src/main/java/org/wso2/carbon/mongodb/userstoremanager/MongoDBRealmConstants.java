...
public class MongoDBRealmConstants {
	 ...
	 public static final String SELECT_USER = "SelectUserMONGO_QUERY";
	    ...
	    public static final String GET_USER_ROLE_MONGO_QUERY = "{'collection' : 'UM_ROLE',$match : {'UM_TENANT_ID' : '?','userRole.UM_TENANT_ID' : '?','user.UM_TENANT_ID' : '?','user.UM_USER_NAME' : '?'},'$project' : {'UM_ROLE_NAME' : 1},'$lookup' : [{'from' : 'UM_USER_ROLE','localField' : 'UM_ID','foreignField' : 'UM_ROLE_ID','as' : 'userRole'},{'from' : 'UM_USER','localField' : 'UM_ID','foreignField' : 'UM_ROLE_ID','as' : 'users'}]}";
	    ...
	    public static final String GET_USERS_IN_ROLE_MONGO_QUERY = "{'collection' : 'UM_USER',$match : {'UM_TENANT_ID' : '?','role.UM_ROLE_NAME' : '?','role.UM_TENANT_ID' : '?','userRole.UM_TENANT_ID' : '?'},'$project' : {'UM_USER_NAME' : 1},'$lookup' : [{'from' : 'UM_USER_ROLE','localField' : 'UM_ID','foreignField' : 'UM_USER_ID','as' : 'userRole'},{'from' : 'UM_ROLE','localField' : 'UM_USER_ROLE.UM_ROLE_ID','foreignField' : 'UM_ROLE.UM_ID','as' : 'role'}]}";
